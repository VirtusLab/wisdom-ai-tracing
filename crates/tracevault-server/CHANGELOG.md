...
## [0.18.0](https://github.com/VirtusLab/visdom-ai-tracing/compare/v0.17.3...v0.18.0) - 2026-06-12

### Added

- Anthropic proxy usage capture + per-org analytics with hook/proxy dedup ([#239](https://github.com/VirtusLab/visdom-ai-tracing/pull/239))
...
- *(branches)* correct SUM(DISTINCT) cost aggregation bug ([#191](https://github.com/VirtusLab/visdom-ai-tracing/pull/191))
- *(proxy)* do not follow upstream redirects (SSRF / key-leak guard) ([#233](https://github.com/VirtusLab/visdom-ai-tracing/pull/233))
...
## [0.17.3](https://github.com/VirtusLab/visdom-ai-tracing/compare/v0.17.2...v0.17.3) - 2026-06-10
