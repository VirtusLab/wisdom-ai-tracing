...
///
/// Returns agent-readable Markdown instructions derived from the active policies
/// for this repo. Consumed by the CLI (`tracevault agent-policies`), the
/// `agent_policies` MCP tool, and the dashboard preview.
